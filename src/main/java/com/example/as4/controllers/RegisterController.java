...
import com.example.as4.service.EmailSender;
import com.example.as4.service.UserService;
import com.example.as4.utils.EmailTemplate;
import com.example.as4.utils.SimpleStringUtils;
...
public class RegisterController {
    ...
    public Map sendEmailegister(@RequestBody RegisterModel user) {
        ...
        if (found == null)
            return templateCRUD.notFound("Email not found"); //throw new BadRequest("Email not found");
